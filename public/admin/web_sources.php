...
<aside class="w-64 bg-white border-r-4 border-c_secondary text-c_text hidden md:flex flex-col z-20">
    ...
    <div class="flex-grow py-6 px-4 space-y-3">
        ...
        <a href="web_sources.php" class="clay-btn flex items-center gap-3 px-4 py-3 bg-c_primary text-white border-2 border-c_primary_dark shadow-[0_4px_0_0_#DB2777] rounded-2xl font-bold cursor-pointer">
